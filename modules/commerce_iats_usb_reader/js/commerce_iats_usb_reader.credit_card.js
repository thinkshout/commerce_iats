  ...
  Drupal.behaviors.commerce_iats_usb_reader_credit_card = {
    attach: function (context, settings) {
      ...
      encrypted_element.focusin(function () {
        $("#edit-payment-details-encrypted-credit-card-status").html('Swipe credit card now.');
      });

      // When the card data field loses focus, instruct the user to regain focus.
      encrypted_element.focusout(function (e) {
        $("#edit-payment-details-encrypted-credit-card-status").html('<a href="#" onclick="Drupal.behaviors.commerce_iats_usb_reader_credit_card.card_focus(); return false">Click to swipe credit card</a>');
      });
